...
lib.extendMkDerivation {
  ...
  extendDrvArgs = _: {
    ...
    || throw "You cannot enable both debugging and compression."; let
    ...
    in
      ...
      || throw "elm-optimize-level-2 does not support multiple entries."; let
        registryDat = generateRegistryDat {inherit elmLock;};
        doElmPackagePatches =
          builtins.isList elmPackagePatches
      ...
      in {
        ...
        patchElmPackagesPhase =
          lib.optionalString doElmPackagePatches
        ...
        contentHashingPhase =
          lib.optionalString doContentHashing
          (assert (hashLength >= 1 && hashLength <= 64)
            ...
            "hashLength must be between 1 and 64 inclusive: ${
              ...
              for file in "$out"/*; do
                ...
                ${
                if keepFilesWithNoHashInFilenames
                then "cp"
                else "mv"
